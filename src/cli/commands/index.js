...
const commands = {
  ...
  config,
  create,
  dedupe: buildUseless("The dedupe command isn't necessary. `spkgm install` will already dedupe."),
  exec,
  generateLockEntry,
  global,
  help,
  ...
  licenses,
  link,
  lockfile: buildUseless("The lockfile command isn't necessary. `spkgm install` will produce a lockfile."),
  login,
  logout,
  list,
  node,
  ...
  pack,
  policies,
  prune: buildUseless("The prune command isn't necessary. `spkgm install` will prune extraneous packages."),
  publish,
  remove,
  run,
  tag,
