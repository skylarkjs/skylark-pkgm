...
const DEFAULTS = exports.DEFAULTS = {
  ...
  'strict-ssl': true,
  'user-agent': [`spkgm/${(_spkgmVersion || _load_spkgmVersion()).version}`, 'npm/?', `node/${process.version}`, process.platform, process.arch].join(' ')
};
...
class YarnRegistry extends (_npmRegistry || _load_npmRegistry()).default {
  ...
  loadConfig() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      const locations = yield _this.getPossibleConfigLocations('spkgmrc', _this.reporter);
...
YarnRegistry.filename = 'spkgm.json';