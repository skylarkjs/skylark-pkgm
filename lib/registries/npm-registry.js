...
class NpmRegistry extends (_baseRegistry || _load_baseRegistry()).default {
  ...
  loadConfig() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (var _iterator3 = yield _this4.getPossibleConfigLocations('npmrc', _this4.reporter), _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
        ...
        if (!_this4.config['spkgm-offline-mirror'] && offlineLoc) {
          const mirrorLoc = config['spkgm-offline-mirror'] = (_path2 || _load_path2()).default.resolve((_path2 || _load_path2()).default.dirname(loc), offlineLoc);
  ...
  getRegistry(packageIdent) {
    ...
    for (var _i4 = 0; _i4 < _arr.length; _i4++) {
      ...
      const registry = this.getScopedOption(scope, 'registry') || this.registries.spkgm.getScopedOption(scope, 'registry');
      if (registry) {
        return String(registry);
      }
    }
