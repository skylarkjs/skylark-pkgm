...
const YARN_REGISTRY = exports.YARN_REGISTRY = 'https://registry.spkgmpkg.com';
const NPM_REGISTRY_RE = exports.NPM_REGISTRY_RE = /https?:\/\/registry\.npmjs\.org/g;

const YARN_DOCS = exports.YARN_DOCS = 'https://spkgmpkg.com/en/docs/cli/';
const YARN_INSTALLER_SH = exports.YARN_INSTALLER_SH = 'https://spkgmpkg.com/install.sh';
const YARN_INSTALLER_MSI = exports.YARN_INSTALLER_MSI = 'https://spkgmpkg.com/latest.msi';

const SELF_UPDATE_VERSION_URL = exports.SELF_UPDATE_VERSION_URL = 'https://spkgmpkg.com/latest-version';
...
const FALLBACK_GLOBAL_PREFIX = exports.FALLBACK_GLOBAL_PREFIX = path.join(userHome, '.spkgm');

const META_FOLDER = exports.META_FOLDER = '.spkgm-meta';
const INTEGRITY_FILENAME = exports.INTEGRITY_FILENAME = '.spkgm-integrity';
const LOCKFILE_FILENAME = exports.LOCKFILE_FILENAME = 'spkgm.lock';
const METADATA_FILENAME = exports.METADATA_FILENAME = '.spkgm-metadata.json';
const TARBALL_FILENAME = exports.TARBALL_FILENAME = '.spkgm-tarball.tgz';
const CLEAN_FILENAME = exports.CLEAN_FILENAME = '.spkgmclean';
...
const SINGLE_INSTANCE_FILENAME = exports.SINGLE_INSTANCE_FILENAME = '.spkgm-single-instance';
