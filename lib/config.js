  ...
  init(opts = {}) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (var _iterator2 = Object.keys((_index2 || _load_index2()).registries), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
        ...
        const extraneousRcFiles = Registry === (_index2 || _load_index2()).registries.spkgm ? _this.extraneousYarnrcFiles : [];
      ...
      _this.pruneOfflineMirror = Boolean(_this.getOption('spkgm-offline-mirror-pruning'));
      _this.enableMetaFolder = Boolean(_this.getOption('enable-meta-folder'));
      _this.enableLockfileVersions = Boolean(_this.getOption('spkgm-enable-lockfile-versions'));
      _this.linkFileDependencies = Boolean(_this.getOption('spkgm-link-file-dependencies'));
