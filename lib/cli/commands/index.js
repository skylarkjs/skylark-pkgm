...
const commands = {
  ...
  dedupe: (0, (_useless || _load_useless()).default)("The dedupe command isn't necessary. `spkgm install` will already dedupe."),
  ...
  lockfile: (0, (_useless || _load_useless()).default)("The lockfile command isn't necessary. `spkgm install` will produce a lockfile."),
  ...
  prune: (0, (_useless || _load_useless()).default)("The prune command isn't necessary. `spkgm install` will prune extraneous packages."),
