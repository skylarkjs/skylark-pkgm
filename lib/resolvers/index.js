...
function _load_spkgmResolver() {
  return _spkgmResolver = _interopRequireDefault(require('./registries/spkgm-resolver.js'));
}
...
const registries = exports.registries = {
  ...
  spkgm: (_spkgmResolver || _load_spkgmResolver()).default
};
